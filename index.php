...
<section class="rw-wrapper">
	...
	<!--content-->
		<div class="content">
		   ...
		   <img src="images/pi.jpg" class="img-responsive" alt=""/><div class="b-wrapper1 long-img"><p class="b-animate b-from-right    b-delay03 ">ABLY SHOP</p><label class="b-animate b-from-right    b-delay03 "></label><h3 class="b-animate b-from-left    b-delay03 ">Trendy</h3></div></a>
			...
			<div class="content-mid">
				...
				<div class="mid-popular">
					...
					<div class="pro-img">
						...
						<div class="women-top">
							<span>Women</span>
							<h6><a href="single.php">Ably shop</a></h6>
							</div>
					...
					<div class="pro-img">
						...
						<div class="women-top">
							<span>Men</span>
							<h6><a href="single.php">Formals</a></h6>
							</div>
							<div class="img item_add">
								<a href="#"><img src="images/ca.png" alt=""></a>
							</div>
